...
`cargo xtask sync-ai`. Protocol: see the "Memory protocol" section of `.ai/context.md`.

Terse entries only. Durable team decisions → commit message / `docs/adr/`, NOT here.
**NEVER write secrets here** — no private keys, `.env` values, signed payloads, bearer tokens.
